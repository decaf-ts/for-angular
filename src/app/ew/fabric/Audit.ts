...
import { DecafComponent, uielement, UIFunctionLike, uilayout, uilistmodel, uiprop, uitablecol } from "@decaf-ts/ui-decorators";
...
export class Audit extends FabricBaseModel {
  ...
  @uitablecol(4, async(value: string | object, instance: DecafComponent & {translate: UIFunctionLike}) => {
    if(typeof value === 'object')
      value = JSON.stringify(value);
    return value.length ?
      await instance.translate('audit.view_diffs') : '';
  })
