...
/**
 * @description A key-value record type
 * @summary A simple type representing a record with string keys and any values.
 * Used throughout the application for representing generic object structures.
