...
export const content = {
  title: "Defac For Angular",
  sections: [
    {
      title: "Configure your project",
      description: "Because Storybook works separately from your app, you'll need to configure it for your specific stack and setup. Below, explore guides for configuring Storybook with popular frameworks and tools. If you get stuck, learn how you can ask for help from our community.",
      items: [
        {
          image: Styling,
  ...
  socials: [
    {
      image: Github,
      alt: "Github logo",
      description: "Join our contributors building the future of UI development.",
